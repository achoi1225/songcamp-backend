    ...
    const albums = await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          credit: 'faucibus justo a, pulvinar urna. Mauris maximus, magna a varius hendrerit, ligula sapien viverra lacus, sed efficitur tortor justo at leo. ',
          artistId: 13,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Sed in porta tellus, ac pretium elit. Proin sollicitudin ex imperdiet, pellentesque ipsum in, iaculis elit.',
          artistId: 14,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Ut in velit purus. Nullam sit amet tellus lacinia, sollicitudin libero pretium, fermentum augue. Donec eget diam quis libero pulvinar vehicula.',
          artistId: 15,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Nullam quis auctor leo, et facilisis urna. ',
          artistId: 16,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Etiam eu justo eu est vestibulum faucibus. Quisque hendrerit mauris at pretium viverra. Praesent luctus elit quis nisi pharetra eleifend.',
          artistId: 17,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Proin blandit efficitur felis, a rutrum nisl. Sed ante lacus, tincidunt a justo egestas, convallis auctor dui. Interdum et malesuada fames.',
          artistId: 18,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Phasellus auctor dolor et pellentesque egestas. Cras in lacus eu leo ultrices sodales eu sed nisl. Morbi posuere nibh vel leo fringilla, sit amet semper velit sodales.',
          artistId: 19,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          credit: 'Nulla facilisi. Suspendisse a aliquet urna.',
          artistId: 20,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
